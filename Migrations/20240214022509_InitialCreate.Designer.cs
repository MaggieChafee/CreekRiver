...
namespace CreekRiver.Migrations
{
    ...
    [Migration("20240214022509_InitialCreate")]
            ...
            modelBuilder.Entity("CreekRiver.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CampsiteId = 1,
                            CheckinDate = new DateTime(2024, 2, 13, 0, 0, 0, 0, DateTimeKind.Local),
                            CheckoutDate = new DateTime(2024, 2, 16, 0, 0, 0, 0, DateTimeKind.Local),
                            UserProfileId = 1
                        });
                });
